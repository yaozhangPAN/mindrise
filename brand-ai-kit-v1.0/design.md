...
1. **静态沉静，动态点亮**：基础界面以深青墨和中性背景构建；灵芽绿只用于正在发生的关键行为。
...
| Token | Hex | 角色 | 主要用途 |
|---|---:|---|---|
| `brand-ink` | `#004951` | 深青墨 | Logo、标题、主导航、深色背景、主要文字 |
...
4. `active surface`：使用浅灵芽绿色或深青墨强调。
...
“AI生成”使用浅灵芽绿背景和深青墨文字；不可只用一个绿色圆点表达。
...
灵芽绿`#B8E43A`不适合承载白色正文。其上的文字使用深青墨`#00383E`。
